...
import './event.scss'
import { Libre_Baskerville, Courgette } from "next/font/google";
    ...
    return (
        <main>
            <div className='h-screen hero flex justify-center items-center flex-col' >
                ...
                <p className="text-2xl lg:text-4xl flex flex-col lg:block text-center ">
                ...
                <p className={`text-3xl lg:text-5xl mt-8 mb-16 ${courgette.className}`}>A limited release black lager</p>
            ...
            <div className="section-dark ">
                <div className="container m-auto text-center py-20 text-white">
                    <h2 className="text-6xl">$20 Donation, $1 Beer</h2>
                    <p className="text-4xl leading-12 max-w-5xl my-10 mx-auto">Donate <span className="font-bold text-[#be1e2e]">$20</span> or more to the Crawford County Historical Society and get your next beer at Rolling Oak for <span className="font-bold text-[#be1e2e]">$1</span>. Donations can be made online or mailed check. Lasts from October 5 to December&nbsp;31. </p>
                </div>

            </div>
            <div className="h-screen section-light">
                <div className="container mx-auto py-20">
                    <ImagePromoBlock
                        heading='Oak-toberfest Launch'
                        body={`October 5, 2024\r\n
                        3 to 10pm Rolling Oak Brewery`}
            ...
            <div className="h-screen section-dark">
                <div className="container mx-auto py-20">
                    <ImagePromoBlock
                        reverse
                        textColor='white'
            ...
            <div className="section-light">
                <div className="container mx-auto py-20 flex flex-col items-center justify-center">
                    <h2 className="text-5xl mb-5">Questions? Comments?</h2>
                    <p className="text-3xl mb-10">Reach out to the historical society</p>
                    <Button
