...
const Hero = ({text, image, skinny}) => {
    return (
        <div className={`w-screen bg-cover bg-left md:bg-center relative flex items-center justify-center px-2 ${skinny ? 'h-80' : 'h-125'}`} style={{backgroundImage: `url(/images/${image})`}}>
